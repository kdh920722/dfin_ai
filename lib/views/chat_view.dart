...
class ChatViewState extends State<ChatView> with WidgetsBindingObserver{
  ...
  Widget _getChatBox(Map<String, String> message){
    ...
    if (thisId == messageId) {
      ...
      return Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: boxAlignType, children: [
        Card(
            shape: RoundedRectangleBorder(borderRadius: borderType),
            elevation: 3,
            shadowColor: Colors.grey,
            child: Container(padding: const EdgeInsets.all(15),
                constraints: BoxConstraints(maxWidth: Config.appRealSize[0]-30, maxHeight: Config.appRealSize[1]-50),
  ...
  Widget build(BuildContext context) {
    ...
    Widget contents = Container(width: Config.appRealSize[0].w, color: ColorStyles.finAppWhite, child:Column(
      mainAxisAlignment: MainAxisAlignment.start,
      children: [
        Container(height: Config.appRealSize[1].h*0.9, color: ColorStyles.finAppGreen, padding : const EdgeInsets.all(10),
        ...
        UiUtils.getMarginBox(Config.appRealSize[1].h*0.005, 0),
        Container(width: Config.appRealSize[0].w*0.95, height: Config.appRealSize[1].h*0.095, color: ColorStyles.finAppWhite,
            child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
              SizedBox(width: Config.appRealSize[0].w*0.95*0.75, child: TextField(
