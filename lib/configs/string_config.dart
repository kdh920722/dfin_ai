...
class StringConfig{
  static String appIntroduceText = """ 
주식회사 아침해파이낸셜대부 l 대부협회 등록번호: CLFA-협회등록-06730 l 등록기관: 고양시청 일자리경제국 l TEL 031-8075-3545 
서비스명: 업핀 l 사업자등록번호: 676-86-00723 l 주소: 경기도 고양시 덕양구 권율대로 656, 717, 718호(원흥동 클래시아더퍼스트) l 대표번호: 1800-9221 l 대표: 권미희
대출금리 연 20%이내 (연체금리는 약정금리 +3% 이내, 최대 연20% 이내)l연체금 보유, 신용점수 등 낮음등의 사유로 대출이 제한될 수 있습니다. 담보 물건, 담보종류 등에 따라 대출조건(이자율,기한등)이 차등 적용되며, 담보물이 부적합할 경우 대출이 제한될 수 있습니다. 담보대출의 경우 중도상환수수료, 담보권설정비용이 발생 될 수 있습니다. 중도상환수수료는 최대3%로 대부업법에 따른 최고 이자율이내에서 대출기간에 따라 차등 적용 됩니다. 예시:이자는 매월 약정일에 부과. 100만원을 연 20%로 12개월 동안 원리금균등상환 시 총 납부금액 1,111,662원 일정기간 납부해야 할 원리금이 연체될 경우에 계약만료 기한이 도래하기 전에 모든 원리금을 변제해야 할 의무가 발생할 수 있습니다. 금융소비자는 금소법 제19조제1항에 따라 해당상품 또는 서비스에 대하여 설명을 받을 권리가 있으며, 그 설명을 듣고 내용을 충분히 이해한 후 거래하시기 바랍니다. 계약을 체결하기 전 자세한 내용은 상품설명서와 약관을 읽어보시기 바랍니다.
"과도한 빚은 당신에게 큰 불행을 안겨줄 수 있습니다.
대출 시, 상환능력에 비해 대출금이 과도할 경우 귀하의 신용등급 또는 개인신용평점이 하락할 수 있습니다.
""업핀""은 본 서비스를 통한 대출계약, 대출 실행 등과 관련하여 금융소비자로부터 어떠한 금전적 대가도 받지 않습니다."
"㈜아침해파이낸셜대부는 다수의 금융회사와 대출모집업무 위탁계약을 체결하였습니다.
㈜아침해파이낸셜대부는 대출의 승인 및 대출계약 체결에 대한 권한을 갖지 않으며, 대출의 승인 및 대출계약 체결권은 금융상품직접판매업자인 제휴 금융회사가 갖습니다."
  """;
