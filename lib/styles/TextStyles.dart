...
class TextStyles {
  ...
  static TextStyle upFinTextFormFieldTextStyle = TextStyle(fontFamily: "SpoqaHanSansNeo", fontSize: 13.sp, color: ColorStyles.upFinBlack, fontWeight: FontWeight.w500, decoration: TextDecoration.none, decorationThickness: 0.0, height: 1.5);
  static TextStyle upFinSmallTextFormFieldTextStyle = TextStyle(fontFamily: "SpoqaHanSansNeo", fontSize: 11.sp, color: ColorStyles.upFinBlack, fontWeight: FontWeight.w500, decoration: TextDecoration.none, decorationThickness: 0.0, height: 1.5);
  ...
  static TextStyle upFinSelectedTabTextInButtonStyle = TextStyle(fontFamily: "SpoqaHanSansNeo", fontSize: 12.sp, color: ColorStyles.upFinButtonBlue, fontWeight: FontWeight.w500, decoration: TextDecoration.none, decorationThickness: 0.0, height: 1);
  ...
  static TextStyle upFinHtmlTextStyle = TextStyle(fontFamily: "SpoqaHanSansNeo", fontSize: 17.sp, color: ColorStyles.upFinBlack, fontWeight: FontWeight.w500, decoration: TextDecoration.none, decorationThickness: 0.0, height: 1);
